...
export const checkChecksum = async ({ version, filepath, response, fetchOpts }: CheckOptions) => {
  try {
...
const getChecksumLines = async (version: string, fetchOpts: CheckOptions["fetchOpts"]) => {
