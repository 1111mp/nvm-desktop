...
const IpInput: React.FC<IpInputProps> = memo(
  forwardRef<HTMLDivElement, IpInputProps>(
    ({ className, value: propValue = '...', onChange }, ref) => {
          ...
          {value.map((val, i) => (
            <div key={i} className='inline-block '>
              <input
                ...
                className='w-8 border-none outline-none bg-transparent focus:border-none focus:outline-none text-center'
